...
<template>
    <div >
            ...
            <el-carousel :interval="3000" type="card" height="350px">
                <el-carousel-item v-for="item1 in imgs" :key="item1.id">
                    <h3 class="medium">{{item1}}</h3>
                </el-carousel-item>
            </el-carousel>
        ...
        <div class="box" id="app" >
            <ul>
                <li :class="li.class"  v-for="li in licontainer" @mouseover="changeActive($event)" @mouseleave="removeActive($event)">
                    ...
                    <el-button style="margin-top: 7px" type="primary">购 买</el-button>
                    <h3>{{li.name}}</h3>
                    <p>{{li.text}}</p>
                </li>
            ...
            <ul>
                <li :class="item.class"  v-for="item in licontainer" @mouseover="changeActive($event)" @mouseleave="removeActive($event)">
                    ...
                    <img :src="item.cover" alt="img">
                            ...
                            <el-form ref = "bookInformation" :model="detailBookInformation" label-width="120px">
                                <el-form-item label = "书名">
                                    <span  style = "width:100%">{{detailBookInformation.bookname}}</span>
                                </el-form-item>

                                <el-form-item label = "作者">
                                    <span  style = "width:100%">{{detailBookInformation.authorName}}</span>
                                </el-form-item>

                                <el-form-item label = "图片">
                                        <div style = "width:100%"> <img :src = "detailBookInformation.cover"  /></div>
                                </el-form-item>
...
&lt;!&ndash;                                <div>
                                ...
                                <el-form-item label = "简介">
                                    <span  style = "width:100%">{{detailBookInformation.synopsis}}</span>
                                </el-form-item>
                            </el-form>
                            </div>-->
                    <h3>{{item.bookname}}</h3>
